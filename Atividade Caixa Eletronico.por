programa
{
	...
	funcao processa_saque(inteiro valor_saque)
	{
		...
		// o resultado indica o número de notas de 50 reais que aparecerão ao escolher um número > ou = 50. 
		// O valor restante é <50, sendo "descartado".
		notas_20 = valor_saque % 50 / 20
		// o resultado indica o número de notas de 20 reais que aparecerão ao escolher um número > ou = 20, considerando o resto 
		// da divisão do valor de saque por 50, ou se o valor de saque for < 50.
		notas_10 = valor_saque % 50 % 20 / 10
		// O resultado indica o número de notas de 10 reais que aparecerão ao escolher um número > ou = 10, considerando o resto
		// do valor após a retirada das notas de 50 e 20. O que restar e for < 20 será / 10, resultando na quantia de cédulas de 10.
	}
